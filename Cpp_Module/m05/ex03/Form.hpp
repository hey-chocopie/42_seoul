...
//		class GaaaaaradeTooLowException : public std::exception{
//			const char *what() const throw();
//		};
...
//			public :
//				MeCustomException( std::string str ):err_str(str){};
//				//~MyCustomException(){};
		...
		void				check_grade_and_signed(Bureaucrat const & rhd) const;
