...
int     main(void)
{
     ...
     *
     * */
    ft_erase(mp, 25); // right != NULL; left != NULL 0
    ft_erase(mp, 55); // right != NULL; left != NULL 1
     ...
     *
     * */
    ft_erase(mp, 24); // right != NULL; left != NULL 2
    ft_erase(mp, 54); // right != NULL; left != NULL 3
     ...
     *
     * */
    ft_erase(mp, 22); // right == NULL; left == NULL 4
    ft_erase(mp, 51); // right == NULL; left == NULL 5
    ft_erase(mp, 21); // right == NULL; left != NULL 6
    ft_erase(mp, 53); // right != NULL; left == NULL 7
     ...
     *
     * */
    ft_erase(mp, 20); // right == NULL; left != NULL 8
     ...
     *
     * */
    ft_erase(mp, 23); // right != NULL; left != NULL 9
     ...
     *
     * */
    ft_erase(mp, 42); // right != NULL; left != NULL; parent == NULL 10
     ...
     *
     * */
//  ft_erase(mp, 38); // right != NULL; left != NULL; parent == NULL 11
     ...
     *
     * */
    ft_erase(mp, 35); // right != NULL; left != NULL; parent == NULL 12
     ...
     *
     * */
    ft_erase(mp, 33); // right != NULL; left != NULL; parent == NULL 13
