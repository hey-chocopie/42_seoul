...
/*   Updated: 2020/08/30 03:13:29 by hoylee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void			ft_count1_minus0_printf(struct person *width,
...
void			ft_count0_printf(struct person *width,
...
void			ft_st_print(struct person *width, char *st, long long int *x)
{
	if (((*width).value_minus)-- == 1 && st[0] != 0)
	{
		((*width).result)++;
...
void			ft_st_print_minus(struct person *width,
